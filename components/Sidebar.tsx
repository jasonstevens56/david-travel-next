...
import {getAllPublishedPosts, getPublishedCategories} from '@/lib/content'

export default async function Sidebar() {
  const recent = (await getAllPublishedPosts()).slice(0, 8)
  const categories = (await getPublishedCategories()).slice(0, 12)
